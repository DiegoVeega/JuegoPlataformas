...
public class Handler {
	...
	public void render(Graphics g) {
		...
		for(int i=0;i<tile.size();i++) {
			Tile t = tile.get(i);
			if(NombreJuego.getVisibleArea()!=null&&t.getBounds().intersects(NombreJuego.getVisibleArea())) t.render(g);
		}
	...
	public void tick() {
		...
		for(int i=0;i<tile.size();i++) {
			Tile t = tile.get(i);
			if(NombreJuego.getVisibleArea()!=null&&t.getBounds().intersects(NombreJuego.getVisibleArea())) t.tick();
		}
	}
